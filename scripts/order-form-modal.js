function orderForm() {
    ...
    function modalHandler(evt) {
      ...
      const formValid = orderFormValid();
      if (modalBtnOpen && formValid) { // open btn click
...
function orderFormValid() {
    let orderFormPhoneNumber = document.querySelector('#order-form-phone-number');
    let orderFormCheckbox = document.querySelector('#remember');
    return orderFormPhoneNumber.value && orderFormCheckbox.checked ? true : false;
}
